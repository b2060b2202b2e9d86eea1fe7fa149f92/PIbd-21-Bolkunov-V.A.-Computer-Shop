...
namespace ComputerShopBusinessLogic.BusinessLogics
{
    static class SaveToExcel
    {
        public static void CreateDoc(ExcelInfo info)
        {
                ...
                SpreadsheetDocument.Create(info.FileName, SpreadsheetDocumentType.Workbook))
            {
                ...
                InsertCellInWorksheet(new ExcelCellParameters
                {
                    ...
                    ShareStringPart = sharedStringTablePart,
                    ColumnName = "A",
                    RowIndex = 1,
                    Text = info.Title,
                    StyleIndex = 2U
        ...
        {
            var sheetData = cellParameters.Worksheet.GetFirstChild<SheetData>();
            ...
            cellParameters.ShareStringPart.SharedStringTable
                .AppendChild(new SharedStringItem(new Text(cellParameters.Text)));
        ...
        private static void MergeCells(ExcelMergeParameters mergeParameters)
        {
            ...
            else
            {
                ...
                {
                    mergeParameters.Worksheet.InsertAfter
                        (mergeCells, mergeParameters.Worksheet.Elements<CustomSheetView>().First());
                }
                else
                {
                    mergeParameters.Worksheet.InsertAfter
                        (mergeCells, mergeParameters.Worksheet.Elements<SheetData>().First());
                }
            }
